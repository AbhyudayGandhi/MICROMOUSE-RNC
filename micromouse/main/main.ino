...
// Use 6-DoF (accelerometer + gyro) only — no magnetometer
sh2_SensorId_t reportType = SH2_GAME_ROTATION_VECTOR;  // 6-DoF game rotation vector
long reportIntervalUs = 5000; // 5000us = 200 Hz (tweak as needed)
...
movePID();
  ...
  // delay(50);
  // delay(5000);
  moveForward(18,KP_DIST_LEFT, KD_DIST_LEFT ,KP_DIST_RIGHT ,KD_DIST_RIGHT);
  delay(3000);
